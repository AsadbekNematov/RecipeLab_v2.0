...
//  LoremDemo
//
//  Created by Alex Nagy on 18.04.2022.
//
...
public struct LoremPicsum {
    ...
    public static var foodAndDrink: Image {
        Image(foodAndDrinkName, bundle: Bundle.main)
    }
    
    public static var backToSchool: Image {
        Image(backToSchoolName, bundle: Bundle.main)
    }
    
    public static var nature: Image {
        Image(natureName, bundle: Bundle.main)
    }
    
    public static var architecture: Image {
        Image(architectureName, bundle: Bundle.main)
    }
    
    public static var business: Image {
        Image(businessName, bundle: Bundle.main)
    }
    
    public static var fashion: Image {
        Image(fashionName, bundle: Bundle.main)
    }
    
    public static var health: Image {
        Image(healthName, bundle: Bundle.main)
    }
    
    public static var interior: Image {
        Image(interiorName, bundle: Bundle.main)
    }
    
    public static var street: Image {
        Image(streetName, bundle: Bundle.main)
    }
    
    public static var technology: Image {
        Image(technologyName, bundle: Bundle.main)
    }
    
    public static var texture: Image {
        Image(textureName, bundle: Bundle.main)
    }
    
    public static var travel: Image {
        Image(travelName, bundle: Bundle.main)
    }
    
    public static var athletics: Image {
        Image(athleticsName, bundle: Bundle.main)
    }
    
    public static var history: Image {
        Image(historyName, bundle: Bundle.main)
    }
    
    public static var person0: Image {
        Image(person0Name, bundle: Bundle.main)
    }
    
    public static var person1: Image {
        Image(person1Name, bundle: Bundle.main)
    }
    
    public static var person2: Image {
        Image(person2Name, bundle: Bundle.main)
    }
    
    public static var person3: Image {
        Image(person3Name, bundle: Bundle.main)
    }
    
    public static var person4: Image {
        Image(person4Name, bundle: Bundle.main)
    }
    
    public static var person5: Image {
        Image(person5Name, bundle: Bundle.main)
    }
    
    public static var person6: Image {
        Image(person6Name, bundle: Bundle.main)
    }
    
    public static var person7: Image {
        Image(person7Name, bundle: Bundle.main)
    }
    
    public static var person8: Image {
        Image(person8Name, bundle: Bundle.main)
    }
    
    public static var person9: Image {
        Image(person9Name, bundle: Bundle.main)
    }
